---
name: sc-grn-communication
description: Gene regulatory network inference with pySCENIC (GRNBoost2, motif pruning, AUCell) and cell-cell communication with LIANA, NicheNet, CellChat. Use when inferring transcription-factor activity or ligand-receptor interactions between cell types.
---
