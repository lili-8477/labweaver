---
name: sc-atac
description: scATAC-seq: preprocessing, QC (TSS enrichment, fragment size distribution, nucleosome signal), peak calling, TF motif enrichment (chromVAR), and scRNA-scATAC integration with SnapATAC2, ArchR, or Signac. Use for chromatin accessibility data.
---
