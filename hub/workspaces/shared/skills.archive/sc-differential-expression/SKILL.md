---
name: sc-differential-expression
description: Differential expression between conditions with pseudobulk (edgeR / DESeq2 / limma-voom), compositional analysis (scCODA, milo), gene set enrichment (decoupler, GSEApy), and perturbation modeling. Use when comparing groups, treatments, or timepoints.
---
