---
name: sc-bulk-deconvolution
description: Deconvolving bulk RNA-seq cell-type proportions using a single-cell reference: CIBERSORTx, MuSiC, DWLS, Scaden, BayesPrism. Covers pseudobulk benchmarking and method choice. Use when estimating cell composition of bulk samples.
---
