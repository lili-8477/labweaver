---
name: sc-spatial
description: Spatial transcriptomics (Visium, MERFISH, Xenium, CosMx): neighborhood analysis (Squidpy), spatial domains (SpaGCN, STAGATE, BANKSY), spatially variable genes, spot deconvolution (Cell2location, RCTD), and gene imputation (Tangram). Use for any spatially resolved transcriptomics data.
---
