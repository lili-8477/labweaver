...
description: Single-cell QC, ambient RNA removal, doublet detection, normalization, highly variable gene selection, and dimensionality reduction (PCA, UMAP, t-SNE). Covers MAD-based QC thresholds, SoupX/decontX, scrublet/scDblFinder, and pearson residuals normalization. Use when cleaning a new dataset.
---
