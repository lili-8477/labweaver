---
name: sc-reproducibility
description: Reproducible single-cell analysis: conda / pixi environment management, Docker / Singularity containers, Snakemake / Nextflow workflow orchestration, random seed discipline, and documentation standards. Use when packaging an analysis for sharing.
---
