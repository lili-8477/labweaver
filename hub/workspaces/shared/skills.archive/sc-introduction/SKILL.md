---
name: sc-introduction
description: Guidance on scRNA-seq technology choice (10x / Smart-seq2 / sci-RNA-seq), raw data processing pipelines (CellRanger, STARsolo, Kallisto|bustools), analysis ecosystems (scverse/Bioconductor/Seurat), and converting data between AnnData / SingleCellExperiment / Seurat formats. Use at the start of a new single-cell project.
---
