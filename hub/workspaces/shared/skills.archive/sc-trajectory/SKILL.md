---
name: sc-trajectory
description: Trajectory and pseudotime analysis for differentiation studies: diffusion pseudotime, RNA velocity (scVelo), fate prediction (CellRank / CellRank 2), and lineage tracing (Cassiopeia). Use when studying cell differentiation or developmental lineages.
---
