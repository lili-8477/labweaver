---
name: sc-immune-repertoire
description: Single-cell TCR / BCR repertoire analysis with scirpy: clonotype definition, clonal expansion, repertoire diversity metrics (Shannon, Gini), and integration with the gene-expression modality. Use for immune cell receptor sequencing data.
---
