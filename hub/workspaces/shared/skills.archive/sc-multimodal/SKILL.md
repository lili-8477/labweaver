---
name: sc-multimodal
description: Multimodal single-cell integration strategies: paired (MOFA+, WNN, MultiVI, totalVI) and unpaired (GLUE, bridge integration, Portal). Covers RNA+ATAC, RNA+Protein, and cross-modality transfer. Use when combining modalities from the same or different cells.
---
